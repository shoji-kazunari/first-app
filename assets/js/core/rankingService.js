...
PachiSim.rankingService = (function () {
  ...
  //
  // エヴァ17のST（当たるたびに残り157回転へリセットして継続、継続率約80%）は
  // 理論上無限に伸びうる設計で、30連続当選（約0.1%）でも約72,000発に達する。
  // 50,000だと現実にありえる大勝ちまで誤って弾いてしまうため、60連続当選
  // （約1/120万）でようやく届く水準まで余裕を持たせている。
  const BALLS_CAP = 300000;
