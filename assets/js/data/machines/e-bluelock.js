...
PachiSim.machineRegistry.register({
  ...
  rules: [
    ...
    "RUSH突入率：約55%（図柄揃いの大当りに対して）",
    "通常時の大当り振り分け（ヘソ入賞時・図柄揃い）：7R・実獲得約980個で通常のままが45.3%、7R・実獲得約980個でエゴイストBATTLEが50.0%、2R・実獲得約280個でエゴイストBATTLEが4.6%、10R・実獲得約1400個でエゴイストBATTLEが0.1%",
