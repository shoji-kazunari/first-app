...
// より高い。BURST BATTLEと同じ「残保留4個+LASTATTACK2回＝計6回」を当てはめると
// 64.2%+(1-64.2%)×15.3%≈69.7%までしか届かず、公表の約78%とは一致しない
// （LT側は独自のLASTATTACK回数・確率がある可能性があるが、1geki.jp・
// p-town.dmm.comとも情報が無いため確認できない）。そのためLT側はresidual
// Attemptsを入れず、素の転落確率のみを実装している。ギャップは既知のまま。）
//
// 【出玉は「実獲得個数」を採用】
