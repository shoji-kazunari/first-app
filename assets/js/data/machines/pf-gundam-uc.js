...
PachiSim.machineRegistry.register({
  ...
  rules: [
    "通常時大当り確率：1/319.7",
    "RUSH中大当り確率：約1/41.1",
    "RUSH突入率：60%（通常時の大当りのうち、電サポが付くのが60%）",
    "RUSHは回転数で終わらない。次の大当りか転落小当り（約1/153.7）を引くまで続く",
    "RUSH継続率：約81%（残保留4回転での引き戻しを含む）",
    "通常時の大当り振り分け（ヘソ入賞時）：10R×2回・実獲得約2800個でRUSHが20%、3R・実獲得約420個でRUSHが40%、3R・実獲得約420個で電サポ無し（通常へ戻る）が40%",
    "RUSH中の大当り振り分け（電チュー入賞時）：10R・実獲得約1400個が100%",
