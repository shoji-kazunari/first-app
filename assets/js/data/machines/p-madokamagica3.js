...
PachiSim.machineRegistry.register({
  ...
  rules: [
    ...
    "RUSH突入率：約55%（通常時の大当りのうち、マギカRUSHへ突入するのが54.0%、アルティメット超RUSHへ直行するのが1.0%）",
    "通常時の大当り振り分け（ヘソ入賞時）：4R・実獲得約360個で通常のままが45.0%、4R・実獲得約360個でマギカRUSH(ST60回)が54.0%、10R・実獲得約1400個でアルティメット超RUSH(ST120回)が1.0%",
