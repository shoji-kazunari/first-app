...
PachiSim.machineRegistry.register({
  ...
  rules: [
    "通常時大当り確率：約1/259.7",
    "RUSH中大当り確率：約1/97.1（電チューロング解放確率）",
    "SPECIAL LycoReco RUSH HYPER DELUXE：ST132回、継続率約75%",
    "RUSH突入率：約50%（通常時の大当りのうち、RUSHへ突入するのが約50%）。突入時は約30%でモードBから、約70%でモードAから開始",
    "通常時の大当り振り分け（ヘソ入賞時）：3R・実獲得約280個で通常のままが20.0%、4R・実獲得約560個で通常のままが30.0%、3R・実獲得約280個でRUSH突入が5.0%、10R・実獲得約1400個でRUSH突入が0.1%、4R・実獲得約560個でRUSH突入が44.9%",
